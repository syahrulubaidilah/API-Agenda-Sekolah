...
@section('content')
           <div class="main-content-inner">
				...
				<div class="page-content">
					...
					<div class="row">
			          	<div class="col-md-6">
							<div class="alert alert-info hide" id="succesMsg">
					...
					<div class="row">
						<div class="col-xs-12">
							<!-- PAGE CONTENT BEGINS -->
							<form class="form-horizontal" id="formSiswa" role="form">
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right" for="form-field-2">Name</label>

									<div class="col-sm-9">
										<input type="text" id="form-field-2" name="name" placeholder="Name" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-2-2" name="email" placeholder="Email" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="password" id="form-field-2-3" name="password" placeholder="Password" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="form-field-2-5" name="position" placeholder="Jabatan" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="clearfix form-actions">
									<div class="col-md-offset-3 col-md-9">
										...
										<button class="btn" type="button" href={{route('page.list-guru')}}>
												<i class="ace-icon fa fa-undo bigger-110"></i>
												Back
										</button>
									</div>
...
<!-- page specific plugin scripts -->
	...
	<script>
 	    ...
 	    $("#btnSimpan").click(function(event) {
 	      ...
 	      $.ajax({
 	        url: '{{route("guru.store")}}', // url post data
 	        dataType: 'JSON',
 	        type: 'POST',
 	        contentType: 'application/x-www-form-urlencoded',
 	        data: $("#formSiswa").serialize(), // data tadi diserialize berdasarkan name
 	        success: function( data, textStatus, jQxhr ){
				...
				// clear validation error messsages
 	            ...
 	            showNotifSuccess();
 	            // clear data inputan
 	            $('#formSiswa').find("input[type=text], textarea").val("");
 	            // kembali kelist User
 	        },
 	      ...
 	      $.ajax({
 	        ...
 	        success: function( data, textStatus, jQxhr ){
				...
				// clear validation error messsages
 	            ...
 	            $('#formSiswa').find("input[type=text], textarea").val("");
 	            // kembali kelist User
				window.location.replace('{{route("page.list-guru")}}');
 	        },
 	        error: function( data, textStatus, errorThrown ){
 	          var messages = jQuery.parseJSON(data.responseText);
 		      console.log( errorThrown );
